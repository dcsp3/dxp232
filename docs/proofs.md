...
| API refinement | API refinement relation | One API safely refines another by structurally refining its components and endpoints | Lifts refinement to whole API specifications |
